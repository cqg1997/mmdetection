...
class RCARetinaNet(BaseDetector):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(RCARetinaNet, self).__init__()
        self.backbone = build_backbone(backbone)
        if neck is not None:
            self.neck = build_neck(neck)
        bbox_head.update(train_cfg=train_cfg)
        bbox_head.update(test_cfg=test_cfg)
        CA_head.update(train_cfg=train_cfg)
        CA_head.update(test_cfg=test_cfg)
        self.ca_head = build_head(CA_head)
    ...
    def init_weights(self, pretrained=None):
        ...
        Args:
            pretrained (str, optional): Path to pre-trained weights.
                Defaults to None.
        """
        super(RCARetinaNet, self).init_weights(pretrained)
